  ...
  <div class="sidebar_container">
    <%
							...
							try
								...
								{
								session.setAttribute("name",fname1);
...
PreparedStatement stmt = con.prepareStatement("select fname1,lname,mail,mno,gen from signup where id='"+b+"' ");
...
%>
      <tr>
        <td><p><b>Profile photo:</b></p></td>
        <td><img src="friends1.jsp?<%=b%>" height="125" width="125"></td>
      </tr>
      <tr>
        <td><p><b>Name:</b></p></td>
        <td><font color="#990000"><%=name%> <%=name1%></font></td>
      </tr>
      <tr>
        <td><p><b>Email id :</b></p></td>
        <td><font color="#990000"><%=name2%></font></td>
      </tr>
      <tr>
        <td><p><b>Mobile :</b></p></td>
        <td><font color="#990000"> <%=name3%></font></td>
      </tr>
      <tr>
        <td><p><b>Gender :</b></p></td>
        <td><font color="#990000"> <%=name4%></font></td>
      </tr>
      <tr>
        <td></td>
        <td><a href="user.jsp">
          <h1><u><strong>BACK</strong></u></h1>
          </a></td>
      </tr>
      <%
}
