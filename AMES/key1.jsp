							...
							try
								{
									...
									ps1=con2.prepareStatement("select fname,video,sdate,msg from uservideo where skey='"+key+"'");
...
</video></td> <td width="337"><font color="#009900"><b><blink>Enter Your Secert Key </blink></b></font>
 <form action="check.jsp" method="post" name="form" onSubmit="return validation();">
      <table border="0">

		<tr bgcolor="#CCFFFF"> 
          <td><font color="#009933"><b>Secert Key:</b></font></td>
          <td><input type="text" name="tv" border="0" size="10"></td>
        </tr>
        <tr bgcolor="#CCFFFF"><td><font color="#009933">&nbsp;</font></td>
          <td><input type="submit" value="play">Get key from mail</td>
        </tr>
