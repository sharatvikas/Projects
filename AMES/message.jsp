...
Connection con4 = DriverManager.getConnection("jdbc:mysql://localhost:3306/framework","root","root");


	PreparedStatement stmt4 = con4.prepareStatement("select recid from friends where sendid='"+fname+"' ");
...
PreparedStatement stmt1 = con1.prepareStatement("select fname,msg1,id1 from message where id1='"+sw+"'");
...
<font color="#663333">shared </font><font color="#006699"><b>a message --></font> <font color="#663333">"<%=r%>"</font><p></p></td></tr>
