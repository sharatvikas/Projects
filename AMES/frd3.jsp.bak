...
PreparedStatement stmt = con.prepareStatement("select fname,id from signup where fname like '%"+v+"%' ");
...
<tr><td><p><font color="#0000FF"><b>Your Request Successfully Sent to  </b></font></p></td><td><b><h2><%=name%></h2></b></td></tr>
