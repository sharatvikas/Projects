		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						<h2 class="title"><font color="#33CC33" face="Arial, Helvetica, sans-serif" size="+2">VIdeo has been Uploaded Sucessfully. It Will </br>be Updated to your page soon.</font>
						</h2>
